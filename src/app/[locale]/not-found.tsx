...
export default function LocaleNotFound() {
  return (
    <>
      <Header />
      <main style={{ backgroundColor: '#1A1714', color: '#ffffff' }} className="font-sans min-h-[80vh] w-full flex flex-col items-center justify-center py-20 relative overflow-hidden">
        {/* Um leve brilho no fundo simulando um farol */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#FFB63D]/10 rounded-full blur-[120px] pointer-events-none"></div>

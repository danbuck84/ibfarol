        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Reading Plan */}
              <a href="/recursos#estudo" className="flex items-center gap-4 bg-white p-4 rounded-xl border border-brand-hairline shadow-sm hover:shadow-md transition-shadow group">

...
export default function PlanVisit() {
  ...
  return (
    <section className="py-16 px-8 bg-brand-canvas border-t border-brand-hairline " id="visita">
          ...
          <div>
            ...
            {status === "success" ? (
              <div className="bg-green-50 border border-green-200 text-green-800 p-6 rounded-lg text-center">
                ...
                <h4 className="text-xl font-bold mb-2">{t('success_title')}</h4>
                <p>{t('success_msg')}</p>
              ...
              <form ref={formRef} onSubmit={handleSubmit} name="visita" data-netlify="true" netlify-honeypot="bot-field" className="space-y-4">
                ...
                {status === "error" && (
                  <p className="text-red-500 text-sm font-medium">{t('error_msg')}</p>
                )}
                <button 
                  type="submit" 
                ...
                >
                  {status === "submitting" ? t('submitting') : t('btn_submit')}
                </button>
              </form>
            )}
          </div>

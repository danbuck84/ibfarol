      ...
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="order-last md:order-first mt-8 md:mt-0">
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <a href="https://open.spotify.com/show/3HrOmNVXUmosBJARnDqC4P?si=0feafb769c624480" target="_blank" rel="noopener noreferrer" className="text-brand-mute hover:text-white transition-colors" aria-label="Spotify">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.54.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15.001 10.62 18.72 12.9c.42.18.6.78.241 1.14zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.6.18-1.2.72-1.38 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.56.3z"/></svg>
            </a>
            <a href="https://wa.me/5512991626321" target="_blank" rel="noopener noreferrer" className="text-brand-mute hover:text-white transition-colors" aria-label="WhatsApp">
            ...
            <a href="mailto:contato@batistafarol.org" className="text-brand-mute hover:text-white transition-colors" aria-label="E-mail">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M2 4h20a2 2 0 012 2v12a2 2 0 01-2 2H2a2 2 0 01-2-2V6a2 2 0 012-2zm0 2v.011l10 6.666 10-6.666V6H2zm20 12V8.65l-10 6.667L2 8.65V18h20z"/></svg>
            </a>
          </div>
        </div>

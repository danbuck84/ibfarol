      ...
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="order-last md:order-first mt-8 md:mt-0">
          ...
          <div className="mt-6 flex items-center gap-4">
            <a href="#" className="text-brand-mute hover:text-white transition-colors" aria-label="Instagram">
            ...
            <a href="#" className="text-brand-mute hover:text-white transition-colors" aria-label="YouTube">

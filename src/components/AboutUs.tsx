...
export default function AboutUs() {
  ...
  return (
    <section className="py-20 px-8 bg-brand-ink relative" id="sobre">
      {/* Decorative Divider */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-brand-primary to-transparent opacity-70"></div>
      
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 pt-8">
